...
if (Mobile.getText(findTestObject('Form data Pemohon/EditText - Nama'), 0).contains(Hohendy.getValue('Nama konsumen', baris))) 
    ...
    Mobile.setText(findTestObject('Form data Pemohon/EditText - Alamat New'), 'Jelambar raya', 0)

    Mobile.hideKeyboard()

    Mobile.setText(findTestObject('Form data Pemohon/EditText - RT (1)'), '003', 0)

    Mobile.hideKeyboard()

    Mobile.setText(findTestObject('Form data Pemohon/EditText - RW (1)'), '002', 0)
        ...
        true) // step 1
		 {
            ...
            Mobile.setText(findTestObject('Object Repository/Form data Pemohon/Search'), 'Jakarta barat', 0)

            Mobile.tap(findTestObject('Object Repository/Kota/Kota JAKARTA BARAT'), 0)

            Mobile.delay(2, FailureHandling.STOP_ON_FAILURE)

            Mobile.tap(findTestObject('Object Repository/Form data Pemohon/Pilih Kecamatan'), 0)

            Mobile.setText(findTestObject('Object Repository/Form data Pemohon/Search'), 'Tambora', 0)

            Mobile.tap(findTestObject('Object Repository/Kecamatan/Kecamatan TAMBORA'), 0)

            Mobile.delay(2, FailureHandling.STOP_ON_FAILURE)

            Mobile.tap(findTestObject('Object Repository/Form data Pemohon/Pilih kelurahan'), 0)

            Mobile.setText(findTestObject('Object Repository/Form data Pemohon/Search'), 'Angke', 0)

            Mobile.tap(findTestObject('Object Repository/Kelurahan/kelurahan ANGKE'), 0)
        ...
        true) // step 1
		 {
         ...
         } else 
			{
				...
				Mobile.setText(findTestObject('Form data Pemohon/No Handphone'), '0818886234', 0)
				
				Mobile.hideKeyboard()
				
				Mobile.setText(findTestObject('Form data Pemohon/Nama Ibu Kandung'), 'HO ling ling', 0)
